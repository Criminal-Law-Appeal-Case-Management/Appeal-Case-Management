...
class JustitiaAPITester:
    def __init__(self, base_url="https://criminal-appeals-au-1.preview.emergentagent.com"):
...
def main():
    ...
    print("=" * 70)
    print(f"Backend URL: https://criminal-appeals-au-1.preview.emergentagent.com")
