      ...
      <header className="bg-slate-900 dark:bg-slate-950 sticky top-0 z-50">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-slate-800 border-t border-slate-700 px-6 py-4 space-y-3">
            ...
            <button 
              onClick={() => navigate("/dashboard")} 
              className="flex items-center gap-2 py-2 text-sky-500 hover:text-sky-400 w-full"
            >
      ...
      <section className="relative py-12 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              <p className="text-sky-600 dark:text-sky-500 font-semibold text-xs uppercase tracking-widest">Admin Only</p>
              ...
              {stats?.daily_stats?.map((day, index) => (
                <div key={day.date} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 bg-muted rounded-full h-8 overflow-hidden">
                    <div 
                      className="bg-gradient-to-r from-sky-500 to-sky-600 h-full rounded-full flex items-center justify-end pr-3 transition-all duration-500"
                      style={{ 
