    ...
    <div className="min-h-screen bg-background" style={{ fontFamily: 'Manrope, sans-serif' }}>
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative z-10 text-center">
          ...
          <p className="text-sky-600 dark:text-sky-500 font-semibold text-xs uppercase tracking-widest mb-3">Get in Touch</p>
          ...
          <Link
            to="/legal-resources"
            className="inline-flex items-center mt-4 text-sm font-semibold text-sky-600 hover:text-sky-700"
