...
const STATES = [
  ...
  { code: "sa", name: "South Australia", color: "bg-sky-600" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-16">
        {/* Disclaimer */}
        <div className="mb-8 p-5 bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-800 rounded-xl">
        ...
        <div className="mb-8 bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border-2 border-red-400 dark:border-red-600 rounded-xl p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/70 dark:bg-slate-900/40 rounded-lg p-5 border-l-4 border-sky-500">
              <h3 className="text-lg font-bold text-sky-900 dark:text-sky-200 mb-3">
              ...
              <div className="space-y-3 text-sm text-sky-900 dark:text-sky-100">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="mt-2 text-xs bg-sky-100 dark:bg-sky-900/40 p-2 rounded">
                ...
                <p className="mt-4 bg-sky-200 dark:bg-sky-900/60 p-3 rounded border border-sky-400 dark:border-sky-600 font-medium">
            ...
            {filteredCategories.map(category => (
              <div key={category.id} className="bg-card border border-border rounded-2xl overflow-hidden">
                ...
                >
                  ...
                  <div className={`p-2 rounded-lg transition-colors ${expandedCategories.includes(category.id) ? 'bg-sky-100 dark:bg-sky-900/30' : 'bg-muted'}`}>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {displayStates.map(state => (
                                <Button
                                  ...
                                  className="text-xs rounded-lg hover:bg-sky-50 hover:border-sky-500 hover:text-sky-700 dark:hover:bg-sky-900/20"
                                >
