      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden bg-card border-border">
        ...
        <div className="bg-gradient-to-r from-slate-900 to-indigo-950 px-6 py-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="w-14 h-14 rounded-2xl bg-sky-600 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-sky-600/30">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-sky-600 to-sky-700 text-white hover:from-sky-700 hover:to-sky-800 rounded-xl py-5 font-semibold shadow-lg shadow-sky-600/20"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <button
                type="button"
                onClick={switchMode}
                className="ml-1 text-sky-600 hover:text-sky-700 font-semibold transition-colors"
              >
          ...
          <div className="mt-6 pt-4 border-t border-border">
            ...
            <p className="text-xs text-muted-foreground text-center">
              ...
              {" "}and{" "}
              <a href="/terms" className="text-sky-600 hover:underline">Privacy Policy</a>
            </p>
          </div>
        </div>
      </DialogContent>
