        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-lg border border-slate-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
        ...
        {(!category?.state_legislation || Object.keys(category.state_legislation).length === 0) && (
          <div className="bg-sky-50 border border-sky-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-sky-900">No State-Specific Legislation</p>
        ...
        {category?.key_elements && category.key_elements.length > 0 && (
          <Collapsible open={expandedSections.elements} onOpenChange={() => toggleSection('elements')}>
            <CollapsibleTrigger asChild>
              <Button 
                variant="ghost" 
                className="w-full justify-between p-4 h-auto bg-sky-50 hover:bg-sky-100 rounded-lg"
                data-testid="key-elements-toggle"
              >
                <div className="flex items-center gap-3">
                  <AlertTriangle className="w-5 h-5 text-sky-600" />
                  <span className="font-semibold text-sky-900">Key Elements to Prove</span>
                ...
                <ul className="space-y-2">
                  {category.key_elements.map((element, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-sky-100 text-sky-700 rounded-full flex items-center justify-center text-sm font-medium shrink-0">
                        {idx + 1}
                      </span>
