    ...
    <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 space-y-6" data-testid="timeline-analysis">
      ...
      {hasIssues && (
        <div className="bg-sky-50 border border-sky-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            <p className="font-medium text-sky-800">Issues Found in Timeline</p>
      ...
      {contested_facts.length > 0 && (
        <Card className="border-sky-200">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium flex items-center gap-2 text-sky-800">
          ...
          <CardContent>
            <div className="space-y-3">
              {contested_facts.map((fact, i) => (
                <div key={i} className="bg-white p-3 rounded-lg border border-sky-200">
